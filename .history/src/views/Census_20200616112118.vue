<template>
  ...
  <div>
    ...
    <div class="tu">
    <div style="width:50%,heigth:500px"><ve-pie :data="chartData"></ve-pie></div>
    <div style="width:50%,heigth:500px"><ve-ring :data="chartData2" :settings="chartSettings"></ve-ring></div>
  </div></div>
</template>
