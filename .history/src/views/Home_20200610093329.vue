      ...
      <div class="box-card">
        <el-card class="box-card">
          ...
          <div class="data">
            ...
            <div class="dataDa" >
               <countTo :startVal="startVal" :endVal="this.visits" :duration="3000">
                 </countTo>
               </div>
          </div>
        </el-card>
      ...
      <div class="box-card">
        <el-card class="box-card">
          ...
          <div class="data">
            ...
            <div class="dataDa">
              <countTo :startVal="startVal" :endVal="this.messages" :duration="3000">
      ...
      <div class="box-card">
        <el-card class="box-card">
          ...
          <div class="data">
            ...
            <div class="dataDa">
               <countTo :startVal="startVal" :endVal="this.purchases" :duration="3000">
                 </countTo>
               </div>
          </div>
        </el-card>
      ...
      <div class="box-card">
        <el-card class="box-card">
          ...
          <div class="data">
            ...
            <div class="dataDa">
              <countTo :startVal="startVal" :endVal="this.shopping" :duration="3000">
                </countTo>
              </div>
          </div>
        </el-card>
