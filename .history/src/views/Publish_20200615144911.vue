      ...
      <el-table-column label="类目" width="100">
        <template slot-scope="scope">
          <el-button type="warning" plain  v-if="scope.row.category === 'JavaScript'">{{ scope.row.category }}</el-button>
           ...
           <el-button type="success"  v-if="scope.row.category === 'Node.js'">{{ scope.row.category }}</el-button>
           <el-button type="primary" v-if="scope.row.category === '性能优化'">{{ scope.row.category }}</el-button>
           <el-button type="warning" v-if="scope.row.category === '小程序'">{{ scope.row.category }}</el-button>
        </template>
